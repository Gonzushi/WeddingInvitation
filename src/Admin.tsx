          ...
          <div className="flex flex-col relative">
            ...
            {formData.nickname && (
              <button
                ...
                className="absolute right-3 bottom-2 sm:bottom-1.5 text-gray-500 hover:text-black text-2xl sm:text-xl"
              >
                ✕
              </button>
            )}
          ...
          <div className="flex flex-col relative">
            ...
            {additionalNamesInput && (
              <button
                ...
                className="absolute right-3 bottom-2 sm:bottom-1 text-gray-500 hover:text-black text-2xl sm:text-xl"
              >
                ✕
              </button>
            )}
